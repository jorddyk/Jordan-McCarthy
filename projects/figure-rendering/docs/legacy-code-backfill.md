...
| `projects/figure-rendering/panel-renderers/jm105-figure3-cr-selectivity-v2-1/jm105-figure3-render-v2-1-cr-selectivity.py` | Exact complete source uploaded by Jordan 2026-07-29 (`JM105_figure3_render_v2_1_20260728.py`), originally produced by Claude in the NMD-analysis chat | Six-panel Figure 3 CR-selectivity renderer, `+MUD1` only | **RECOVERED**: complete, unmodified, compiling source committed byte-for-byte. Not yet Euler-run against real data; not yet Jordan-accepted. |
| `projects/figure-rendering/panel-renderers/jm105-figure4-mud1-host-transcript/jm105-figure4-render-v11-2-mud1-coupling.py` | Exact complete source uploaded by Jordan 2026-07-29 (`JM105_figure4_render_v11_2_20260729.py`), originally produced by Claude in the NMD-analysis chat | Eight-panel Figure 4 Mud1-coupling renderer; title matches the current authority PR #12 recorded | **RECOVERED**: complete, unmodified, compiling source committed byte-for-byte. May satisfy PR #12's outstanding "exact renderer" request, but PR #12 also still requires a successful real-data Euler run, hashes, and Jordan's visual acceptance, none of which happened in this pass. |
| `projects/figure-rendering/panel-renderers/jm105-figure4-mud1-host-transcript/jm100-lifespan-to-csv.py` | Exact complete source uploaded by Jordan 2026-07-29 (`JM100_lifespan_to_csv_20260728.py`), originally produced by Claude in the NMD-analysis chat | Converts real `JM100.xlsx` replicative-lifespan data to the CSV Figure 4 panels a/b consume | **RECOVERED**: complete, unmodified, compiling source committed byte-for-byte. Flags a transposed summary sheet and a CR-intensity mismatch (JM100 0.5% vs JM105 RNA-seq 0.1%) rather than silently conflating them. |
