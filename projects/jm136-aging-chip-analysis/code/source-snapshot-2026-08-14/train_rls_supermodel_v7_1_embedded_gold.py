...
# Manual JM135 RLS gold is embedded below so Euler does NOT need access to
# the Windows/SMB NAS. If AGING_GOLD_RLS_PATH points to a readable local file,
# that newer file wins; otherwise the embedded snapshot is used automatically.
GOLD_RLS_PATH = os.environ.get("AGING_GOLD_RLS_PATH", "").strip()
...
OOF_OUT = "v7_1_gold_oof_concordance.csv"
AUDIT_OUT = "v7_1_gold_annotation_audit.csv"
MANIFEST_OUT = "v7_1_run_manifest.json"
...
# =============================================================================
# EMBEDDED MANUAL GOLD SNAPSHOT
# =============================================================================
# Source supplied by Jordan:
# \\nas22.ethz.ch\biol_bc_barrallab_1\Jordan\JM135 CR Mud1 zeropointonepercentglucose\JM135.xlsx
#
# The NAS is not mounted on Euler. These 124 unambiguous
# (position, trap_id, manual_RLS, died_on_chip) records were extracted from the
# uploaded JM135.xlsx snapshot and compiled directly into this trainer.
EMBEDDED_GOLD_SOURCE_UNC = (
    r"\\nas22.ethz.ch\biol_bc_barrallab_1\Jordan"
    r"\JM135 CR Mud1 zeropointonepercentglucose\JM135.xlsx"
)
EMBEDDED_GOLD_WORKBOOK_SHA256 = "f7259c637f1ecac7b1ec59ea5285303f1904eac5c524bc56f52076580f6bca4e"
EMBEDDED_GOLD_ROWS = [(5, 1, 21.0, 1), (18, 3, 35.0, 1), (18, 4, 17.0, 1), (18, 5, 13.0, 1), (18, 6, 40.0, 1), (18, 7, 17.0, 1), (18, 9, 35.0, 1), (18, 10, 20.0, 0), (18, 11, 17.0, 0), (18, 13, 25.0, 0), (18, 14, 31.0, 1), (18, 16, 23.0, 0), (18, 17, 12.0, 1), (18, 18, 21.0, 0), (18, 19, 3.0, 1), (7, 0, 13.0, 1), (7, 2, 33.0, 1), (7, 3, 30.0, 1), (7, 4, 15.0, 1), (7, 5, 19.0, 1), (7, 7, 27.0, 1), (7, 9, 3.0, 1), (7, 11, 10.0, 1), (7, 12, 40.0, 1), (7, 13, 25.0, 0), (7, 14, 13.0, 1), (7, 15, 29.0, 1), (7, 17, 22.0, 1), (7, 18, 18.0, 1), (7, 19, 20.0, 1), (7, 20, 15.0, 1), (7, 21, 22.0, 1), (7, 24, 9.0, 1), (7, 25, 14.0, 1), (7, 26, 29.0, 1), (7, 27, 14.0, 1), (7, 28, 22.0, 1), (7, 31, 34.0, 1), (7, 32, 33.0, 0), (7, 33, 19.0, 1), (7, 35, 19.0, 1), (7, 36, 20.0, 1), (7, 37, 19.0, 1), (7, 38, 29.0, 1), (7, 39, 15.0, 1), (7, 42, 7.0, 0), (15, 0, 22.0, 0), (15, 1, 9.0, 0), (15, 2, 29.0, 1), (15, 3, 26.0, 1), (15, 4, 29.0, 1), (15, 5, 10.0, 0), (15, 7, 27.0, 1), (15, 8, 31.0, 1), (15, 9, 15.0, 1), (15, 10, 25.0, 1), (15, 12, 5.0, 1), (15, 13, 20.0, 0), (15, 14, 24.0, 1), (15, 15, 9.0, 0), (15, 16, 6.0, 0), (15, 17, 30.0, 1), (15, 18, 31.0, 1), (15, 19, 30.0, 1), (15, 20, 27.0, 1), (5, 4, 30.0, 1), (5, 5, 20.0, 1), (5, 6, 34.0, 1), (5, 7, 13.0, 1), (5, 9, 15.0, 1), (5, 10, 26.0, 1), (5, 12, 28.0, 1), (5, 13, 27.0, 1), (5, 14, 9.0, 1), (5, 15, 28.0, 1), (5, 16, 28.0, 1), (5, 17, 27.0, 1), (5, 18, 18.0, 1), (5, 19, 25.0, 1), (5, 20, 19.0, 1), (5, 21, 34.0, 1), (5, 22, 21.0, 1), (5, 23, 26.0, 1), (3, 7, 17.0, 1), (3, 8, 26.0, 1), (3, 11, 2.0, 0), (3, 12, 17.0, 1), (3, 13, 26.0, 1), (3, 14, 22.0, 1), (3, 15, 22.0, 0), (3, 16, 22.0, 1), (3, 17, 24.0, 1), (3, 18, 19.0, 1), (3, 19, 35.0, 1), (3, 20, 23.0, 1), (3, 21, 35.0, 0), (3, 23, 28.0, 1), (3, 24, 40.0, 0), (3, 25, 30.0, 1), (12, 0, 30.0, 1), (12, 1, 25.0, 1), (12, 2, 44.0, 1), (12, 4, 34.0, 1), (12, 5, 19.0, 0), (12, 6, 31.0, 1), (12, 8, 8.0, 0), (13, 0, 15.0, 0), (13, 2, 48.0, 0), (13, 3, 16.0, 0), (13, 4, 16.0, 0), (13, 5, 20.0, 1), (13, 7, 33.0, 0), (13, 8, 25.0, 1), (13, 9, 13.0, 1), (13, 10, 46.0, 0), (13, 11, 25.0, 0), (13, 13, 29.0, 0), (13, 15, 34.0, 1), (13, 16, 23.0, 0), (13, 17, 21.0, 1), (13, 19, 30.0, 1), (13, 21, 3.0, 1), (13, 22, 25.0, 1), (13, 23, 23.0, 0)]
...
def _normalize_gold_dataframe(df):
    """Normalize either the real JM135 workbook or the embedded snapshot."""
    if {"Position_int", "Trap_ID", "Gold_RLS", "Gold_Died"}.issubset(df.columns):
        out = df[["Position_int", "Trap_ID", "Gold_RLS", "Gold_Died"]].copy()
    else:
        tcol = "TRAP Number (For Annotation File)"
        rcol = "Replicative Lifespan"
        dcol = "Dies on chip \n(1 = yes 0 = no)"
        required = {tcol, "Position", rcol}
        missing = required - set(df.columns)
        if missing:
            raise ValueError(f"Gold workbook is missing required columns: {sorted(missing)}")
        df = df[df[tcol].notna() & df["Position"].notna() & df[rcol].notna()].copy()
        out = pd.DataFrame({
            "Position_int": df["Position"].astype(int),
            "Trap_ID": df[tcol].astype(int),
            "Gold_RLS": df[rcol].astype(float),
            "Gold_Died": df[dcol].fillna(0).astype(int) if dcol in df.columns else 0,
        })

    out["Position_int"] = out["Position_int"].astype(int)
    out["Trap_ID"] = out["Trap_ID"].astype(int)
    out["Gold_RLS"] = out["Gold_RLS"].astype(float)
    out["Gold_Died"] = out["Gold_Died"].fillna(0).astype(int)

    dup = out.duplicated(["Position_int", "Trap_ID"], keep=False)
    if dup.any():
...
def read_gold(path=""):
    """Load manual JM135 RLS without requiring the Barral NAS to be mounted.

    Priority:
      1) AGING_GOLD_RLS_PATH if it names a readable Euler-local file.
      2) Embedded snapshot from Jordan's JM135.xlsx.
    """
    if path:
        if os.path.isfile(path):
            try:
                df = pd.read_excel(path)
                out = _normalize_gold_dataframe(df)
                print(f"--> Manual gold: loaded {len(out)} mappings from external file: {path}")
                return out, {
                    "mode": "external_file",
                ...
                print(f"--> WARNING: external gold file exists but could not be parsed ({e}).")
                print("--> Falling back to embedded JM135 manual-gold snapshot.")
        else:
            print(f"--> NOTE: AGING_GOLD_RLS_PATH is not readable on this node: {path}")
            print("--> Using embedded JM135 manual-gold snapshot instead.")

    df = pd.DataFrame(
        EMBEDDED_GOLD_ROWS,
        columns=["Position_int", "Trap_ID", "Gold_RLS", "Gold_Died"],
    )
    out = _normalize_gold_dataframe(df)
    print(f"--> Manual gold: using EMBEDDED JM135 snapshot ({len(out)} trap mappings).")
    print(f"--> Snapshot workbook SHA256: {EMBEDDED_GOLD_WORKBOOK_SHA256}")
    return out, {
        "mode": "embedded_snapshot",
        "source_unc": EMBEDDED_GOLD_SOURCE_UNC,
        "workbook_sha256": EMBEDDED_GOLD_WORKBOOK_SHA256,
        "n_rows": len(out),
    }
...
def main():
    gpu_count = setup_gpu()
    if gpu_count == 0 and os.environ.get("AGING_ALLOW_CPU", "0") != "1":
        raise RuntimeError(
            "No GPU detected. This trainer refuses to run the expensive self-supervised "
            "phase on an Euler login/CPU node. Start a GPU allocation or submit a GPU "
            "Slurm job. Set AGING_ALLOW_CPU=1 only for debugging."
        )
    source_path = os.path.abspath(__file__)
    source_sha = sha256_file(source_path)
    print("=" * 88)
    print("AGING CHIP RLS SUPERTRAINER v7.1 -- EMBEDDED GOLD + MASKED MORPHOLOGY + 11-FRAME EVENT TRANSFORMER")
    ...
    gold, gold_provenance = read_gold(GOLD_RLS_PATH)
